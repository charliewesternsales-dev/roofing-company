...
export const metadata: Metadata = {
  ...
  openGraph: { title: `Portland Residential Roofing | ${site.name}`, description: site.description, type: 'website', locale: 'en_US', images: [{url:'/images/pnw-home.webp',width:1672,height:941,alt:'Pacific Northwest craftsman home — illustrative concept'}] },
...
export default function RootLayout({children}:{children:React.ReactNode}) {
  const structuredData = site.readyToPublish && site.url ? { '@context':'https://schema.org', '@type':'RoofingContractor', name:site.name, url:site.url, telephone:site.phone, email:site.email, description:site.description, areaServed:{'@type':'City',name:'Portland'} } : null;
